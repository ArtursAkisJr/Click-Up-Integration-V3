...
def create_tables():
    ...
    # 14. clickup_fact_BillableOnNonChargeableCheck: Billable hours logged on non-chargeable projects
    cur.execute('''
        CREATE OR REPLACE VIEW public.clickup_fact_BillableOnNonChargeableCheck AS
        SELECT
            te.timesheet_id,
            te.user_id,
            m.username,
